  ...
  return <>
    ...
    <main>
      ...
      <div className="p-16 flex flex-col align-center items-center w-screen justify-center max-w-6xl mx-auto">
        ...
        <p className="mb-6 text-lg font-normal text-slate-500 lg:text-xl sm:px-16 xl:px-48 dark:text-slate-400 text-center">
          Remember to get the best quality candidates, be as descriptive as possible with your job descriptions and requirements.
        </p>
      </div>
      <PostJobForm />
    </main>
